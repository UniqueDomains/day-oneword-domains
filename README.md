...
Daily-updated dataset of available and resale .day one-word domains from Unique Domains.
...
- `day.csv` — public CSV extract (9,329 rows)
- `day.json` — public JSON extract (9,329 rows)
...
| adept.day      | available | $14.99    | $19.99        | 92             | 27     | 5      | name.com                    |
...
| cloud.day      | premium   | $1,298.70 | $1,298.70     | 70             | 59     | 5      | namecheap                   |
...
| ----------------------- | ------------------------------------------------ |
| 9,329-row public sample | 9,329 live domains                               |
...
> Unique Domains. *Available .DAY One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
